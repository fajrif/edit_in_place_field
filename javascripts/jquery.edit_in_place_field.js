...
function EditInPlaceFieldEditor(e) {
...
EditInPlaceFieldEditor.prototype = {
  ...
  bindForm : function() {
    this.activateForm = EditInPlaceFieldEditor.forms[this.formType].activateForm;
    this.getValue     = EditInPlaceFieldEditor.forms[this.formType].getValue;
  },
...
EditInPlaceFieldEditor.forms = {
  "input" : {
    activateForm : function() {
      ...
      this.element.find("form").bind('submit', {editor: this}, EditInPlaceFieldEditor.forms.input.submitHandler);
      this.element.find("input").bind('blur',   {editor: this}, EditInPlaceFieldEditor.forms.input.inputBlurHandler);
      this.element.find("input").bind('keyup', {editor: this}, EditInPlaceFieldEditor.forms.input.keyupHandler);
    },
  ...
  "select" : {
    activateForm : function() {
      ...
      this.element.html(output);
      this.setHtmlAttributes();
      this.element.find("select").bind('change', {editor: this}, EditInPlaceFieldEditor.forms.select.blurHandler);
      this.element.find("select").bind('blur', {editor: this}, EditInPlaceFieldEditor.forms.select.blurHandler);
      this.element.find("select").bind('keyup', {editor: this}, EditInPlaceFieldEditor.forms.select.keyupHandler);
  ...
  "textarea" : {
    activateForm : function() {
      ...
      this.element.find("textarea").bind('blur', {editor: this}, EditInPlaceFieldEditor.forms.textarea.blurHandler);
      this.element.find("textarea").bind('keyup', {editor: this}, EditInPlaceFieldEditor.forms.textarea.keyupHandler);
    },
    ...
    keyupHandler : function(event) {
      if (event.keyCode == 27) {
        EditInPlaceFieldEditor.forms.textarea.abort(event.data.editor);
      }
    },
...
jQuery.fn.edit_in_place_field = function() {
  this.each(function(){
    if (!jQuery(this).data('editInPlaceFieldEditor')) {
      jQuery(this).data('editInPlaceFieldEditor', new EditInPlaceFieldEditor(this));
    }
  });
  return this;
};
